...
/**
  * The observability sinks: `combine` fan-out (logs + metrics side by side) and the otel adapter
  * (Duende's Telemetry counters), including the challenge-vs-failure separation.
  */
