...
/**
  * Central, uniform rendering of any domain error that has a [[ToProblemDetails]] instance. The
  * error → status decision lives in the instance (per error type); this owns only the wire format
